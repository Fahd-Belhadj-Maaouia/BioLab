...
void MainWindow::setupToolsTablePage() {
    ...
    inputLayout->addRow("Fournisseur:", fournisseurCombo);
    inputLayout->addRow("Position Fournisseur:", positionFournisseurInput);
    ...
    connect(toolsManager, &ToolsManager::editToolRequested,
            this, [=](int id) {
                ...
                // Handle fournisseur (NEW: Use text input instead of dropdown)
                QString currentFournisseur = toolData["fournisseur"].toString();
                fournisseurCombo->setText(currentFournisseur);

                // Handle positionFournisseur (NEW: Use text input instead of dropdown)
                QString currentPositionFournisseur = toolData["positionFournisseur"].toString();
                positionFournisseurInput->setText(currentPositionFournisseur);
