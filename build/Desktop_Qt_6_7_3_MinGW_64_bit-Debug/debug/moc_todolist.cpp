...
void ToDoList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ToDoList::*)(const QString & );
            if (_t _q_method = &ToDoList::taskMovedToCompleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ToDoList::*)(const QString & );
            if (_t _q_method = &ToDoList::taskMovedToTodo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ToDoList::taskMovedToCompleted(const QString & _t1)
{
...
// SIGNAL 1
void ToDoList::taskMovedToTodo(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
