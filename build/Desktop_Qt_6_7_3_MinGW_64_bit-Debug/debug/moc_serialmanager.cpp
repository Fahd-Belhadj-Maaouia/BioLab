...
void SerialManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->keyReceived((*reinterpret_cast< std::add_pointer_t<char>>(_a[1]))); break;
        ...
        {
            using _t = void (SerialManager::*)(char );
            if (_t _q_method = &SerialManager::keyReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialManager::keyReceived(char _t1)
{
