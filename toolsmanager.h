...
public:
    ...
    // CRUD Operations
    void loadTools(); // Load tools from the database
    void addTool();   // Add a new tool
    void editTool();  // Edit an existing tool
    void deleteTool(); // Delete a tool

    // Form-related methods
    void showAddToolForm();

private slots:
    void onAddToolSubmitted(); // Slot for form submission
